...
// --- UPDATED: Comprehensive Data for all 18 Somali Regions and their Districts ---
...
function initializeWorkflow() {
    ...
    // MODIFIED: This now listens for the form submission
    ...
    // MODIFIED: This handles the "Yes, I'm Sure" click
    modalConfirmBtn.addEventListener('click', () => {
        ...
        // Reset the entire workflow back to the beginning
        resetWorkflow();
    });

    // MODIFIED: This handles the "Cancel" click
    modalCancelBtn.addEventListener('click', () => {
        // Just hide the modal and let the user continue editing
        modal.classList.add('hidden');
    });
}
...
// --- 6D Code Generation & Box Drawing ---
